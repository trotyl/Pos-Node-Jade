var _ = require('lodash');
  ...
  //console.log(_peel('name==hehe&&(time>0||type==12&&age<18)'));
  ...
  //console.log(_tail('name==hehe&&time>0||type==12&&age<18'));
...
console.log(_render('name==hehe&&(time>0||type==12)&&(age<18||amount>100)'));
console.log(_render('a>1||(b>2&&c==3)'));
console.log(_render('(name==可口可乐||name==百事可乐)&&day<03/09/2014'));
